...
const SelectTip: FC<Props> = ({ handleTip }) => {
  ...
  return (
    <div className="w-[85%]">
      ...
      <div className=" grid grid-cols-2 w-full m-auto gap-4 group-hover:bg-white md:grid-cols-3">
        ...
        <input
          type="number"
          className="bg-VeryLightGrayishCyan grid-span-1 w-full h-[47.66px] text-2xl text-end outline-StrongCyan text-VeryDarkCyan py-[0.365rem] px-[1.1rem] md:text-xl"
          placeholder="Custom"
